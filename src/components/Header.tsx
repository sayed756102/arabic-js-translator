...
const Header: React.FC = () => {
  ...
  const [panelType, setPanelType] = React.useState<
    "purpose" | "policy" | "support" | "contact" | null
  >(null);
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        >
          <img
            src="/lovable-uploads/789bfc04-c3a4-4d55-b126-b12cf5a89722.png"
            alt="شعار ZAS-برمجه"
        ...
        <SheetContent side="right" className="w-full sm:max-w-md">
          <SheetHeader>
            ...
            <SheetDescription>
              {panelType === "purpose" && (
                <>
                  برمج بالعربية، نفذ بالإنجليزية. اكتب أكواد JavaScript بالعربية
                  واحصل على الكود الإنجليزي النهائي مع كشف الأخطاء والتصحيح.
                </>
              )}
              {panelType === "policy" && (
                <>
                  يهدف ZAS-برمجه إلى تسهيل كتابة أكواد JavaScript بالعربية
                  وترجمتها للإنجليزية مع إبراز الأخطاء لتعلمٍ أسرع. لا نقوم بحفظ
                  محتواك على خادم خارجي ضمن هذا الإصدار.
                </>
              )}
              {panelType === "support" && (
                <>
                  ...
                  <div className="mt-3">
                    <a
                      href="mailto:anwersayed531@gmail.com?subject=%D8%AF%D8%B9%D9%85%20ZAS-%D8%A8%D8%B1%D9%85%D8%AC%D9%87"
